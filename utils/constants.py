...
TRANSLATIONS = {
    'en': {
        'common': {
            ...
            'device_selector_title': 'Select Device',
            'fetching_devices': 'Fetching device info...',
            'current_device': 'Current',
            'switch_device': 'Switch',
            'disconnect_device': 'Disconnect',
            'wifi_device': 'WiFi connection',
            'usb_device': 'USB connection',
        },
        'main': {
            'title': 'yaScrcpy',
            ...
            'device_selector_tooltip': 'Select connected device',
        ...
        'apps_tab': {
            ...
            'folders_btn': 'Folders',
            'create_session_btn': 'Create New Folder',
        ...
        'winlator_tab': {
            ...
            'no_icons_to_extract': 'No icons to extract.',
        ...
        'adb_wifi': {
             'title': 'ADB over Wifi',
             'tabs': {'connect': 'Connect', 'pair': 'Pair'},
             'placeholder': 'IP:Port (e.g., 192.168.1.100:5555)',
             'pair_placeholder': 'IP:Port (e.g., 192.168.1.100:37891)',
             'code_placeholder': 'Pairing Code',
             'connect_btn': 'Connect',
             'pair_btn': 'Pair',
             'initial_msg': 'Enter the device IP and port.',
             'pair_initial_msg': 'Enter the device IP:Port and Pairing Code.',
             'empty_error': 'IP:Port cannot be empty.',
             'pair_empty_error': 'IP:Port and Pairing Code cannot be empty.',
             'connecting': 'Connecting to {address}...',
             'pairing': 'Pairing with {address}...',
        },
        'session_manager': {
        ...
        'pt': {
            'common': {
                ...
                'device_selector_title': 'Selecionar Dispositivo',
                'fetching_devices': 'Buscando informações dos dispositivos...',
                'current_device': 'Atual',
                'switch_device': 'Trocar',
                'disconnect_device': 'Desconectar',
                'wifi_device': 'Conexão WiFi',
                'usb_device': 'Conexão USB',
            },
        'main': {
            'title': 'yaScrcpy',
            'tabs': {'apps': 'Apps', 'winlator': 'Winlator', 'config': 'Config'},
            ...
            'device_selector_tooltip': 'Selecione o dispositivo conectado',
        ...
        'apps_tab': {
            ...
            'folders_btn': 'Pastas',
            'create_session_btn': 'Criar Nova Pasta',
        ...
        'winlator_tab': {
            ...
            'no_icons_to_extract': 'Nenhum ícone para extrair.',
        ...
        'adb_wifi': {
             'title': 'ADB via Wifi',
             'tabs': {'connect': 'Conectar', 'pair': 'Parear'},
             'placeholder': 'IP:Porta (ex: 192.168.1.100:5555)',
             'pair_placeholder': 'IP:Porta (ex: 192.168.1.100:37891)',
             'code_placeholder': 'Código de Pareamento',
             'connect_btn': 'Conectar',
             'pair_btn': 'Parear',
             'initial_msg': 'Insira o IP e a porta do dispositivo.',
             'pair_initial_msg': 'Insira o IP:Porta e o Código de Pareamento.',
             'empty_error': 'IP:Porta não pode estar vazio.',
             'pair_empty_error': 'IP:Porta e Código de Pareamento não podem estar vazios.',
             'connecting': 'Conectando a {address}...',
             'pairing': 'Pareando com {address}...',
        },
        'session_manager': {
