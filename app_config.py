...
class AppConfig:
    _DEFAULT_VALUES = {
        ...
        CONF_UPDATE_APPS_ON_STARTUP: True,
        CONF_FORCE_ADB_FORWARD: False,
        CONF_WEB_HOVER_EFFECT: True,
        CONF_QUICK_ACCESS_FACTOR: 1.0,
        CONF_QUICK_ACCESS_VISIBLE: False,
        CONF_SHOW_WINLATOR_TAB: True,

    }
    GLOBAL_KEYS = {CONF_THEME, CONF_LANGUAGE, CONF_SHOW_SYSTEM_APPS, CONF_START_WEB_SERVER_ON_LAUNCH, CONF_HQ_ICON_RENDERING, CONF_WEB_USERNAME, CONF_WEB_PASSWORD, CONF_WEB_PORT, CONF_WEB_HOVER_EFFECT, CONF_QUICK_ACCESS_FACTOR, CONF_QUICK_ACCESS_VISIBLE, CONF_UPDATE_APPS_ON_STARTUP, CONF_SHOW_WINLATOR_TAB}
