...
class AppConfig:
    ...
    GLOBAL_KEYS = {CONF_THEME, CONF_LANGUAGE, CONF_SHOW_SYSTEM_APPS, CONF_START_WEB_SERVER_ON_LAUNCH, CONF_HQ_ICON_RENDERING, CONF_WEB_USERNAME, CONF_WEB_PASSWORD, CONF_WEB_PORT, CONF_WEB_HOVER_EFFECT, CONF_QUICK_ACCESS_FACTOR, CONF_QUICK_ACCESS_VISIBLE, CONF_UPDATE_APPS_ON_STARTUP}
